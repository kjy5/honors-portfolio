...
const INTERNATIONAL_BRAIN_LAB_POSITION_1 = 'https://www.internationalbrainlab.com'
...
const NASA_SUMMER_UNDERGRADUATE_RESEARCH_PROGRAM = 'https://wiki.huskysat.org/wiki/index.php/LOST_SURP_2022'
...
export const linkAssets = {
  'International Brain Lab Position': [INTERNATIONAL_BRAIN_LAB_POSITION_0, INTERNATIONAL_BRAIN_LAB_POSITION_1],
  'Multimodality Final Portfolio': [MULTIMODALITY_FINAL_PORTFOLIO],
  'NASA Summer Undergraduate Research Program': [NASA_SUMMER_UNDERGRADUATE_RESEARCH_PROGRAM],
}
